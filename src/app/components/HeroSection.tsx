...
export function HeroSection() {
  ...
  return (
    <section ref={ref} id="hero" className="min-h-screen flex items-center justify-center px-6 lg:px-8 pt-16 relative overflow-hidden">
      {/* Animated Background */}
      ...
      <motion.div style={{ opacity, scale }} className="max-w-7xl mx-auto w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              >
                {["Senior", "Software", "Engineer"].map((word, i) => (
                  <motion.span
                    key={i}
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
              ...
              >
                React, Micro Frontends & AI Specialist
              </motion.h2>
            </div>
            ...
            >
              10 years building scalable web architectures and integrating Artificial Intelligence solutions.
              Specialized in creating exceptional user experiences and high-performance distributed systems.
            </motion.p>
